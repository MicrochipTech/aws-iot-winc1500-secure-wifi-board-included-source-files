...
public class reportInfo implements Parcelable {
    ...
    public reportInfo(Parcel source) {
    ...
    public static final Parcelable.Creator<reportInfo> CREATOR
            ...
            = new Parcelable.Creator<reportInfo>() {

        public reportInfo createFromParcel(Parcel p) {

            return new reportInfo(p);
...
/*
    ...
    public boolean equals(Object o) {
        ...
        return item.equals(((reportInfo)o).item);
    }
