        ...
        if (boundMessage.size() != 0) {
            ...
            if (boundMessage.get(0) == "QR Mac") {
                if (boundMessage.get(1) == "invalid")
                    Toast.makeText(NetworkProvisionStageOneActivity.this, "Wrong devices", Toast.LENGTH_SHORT).show();
                else {
                    Toast.makeText(NetworkProvisionStageOneActivity.this, "add dev: "+boundMessage.get(1), Toast.LENGTH_LONG).show();
                    //ConnectBoard(boundMessage.get(1));

                    NetworkProvisionStageOneActivity.ConnectTargetBoardTask taskConnectDev = new NetworkProvisionStageOneActivity.ConnectTargetBoardTask();
