...
package com.amazonaws.mchp.awsprovisionkit.opensource.downloader.asyn;
...
public abstract class AsyncTask<Params, Progress, Result> extends
    ...
    public static void setDefaultExecutor(Executor executor) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.i("IllegalArgumentException：" + e);
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
            LogUtils.i("ClassNotFoundException：" + e);
        } catch (NoSuchFieldException e) {
            e.printStackTrace();
            LogUtils.i("NoSuchFieldException：" + e);
        } catch (IllegalAccessException e) {
            e.printStackTrace();
            LogUtils.i("IllegalAccessException：" + e);
        }
    }
